#' ---
#' title: "Supplemental Figures: Forest Plots of MVMR-IVW"
...
#' 
#' - Exposures: PCSK9 protein levels and LDL-C levels in females and sex-combined using PCSK9 & HMGCR instruments
...
plotData1 = plotData1[instrumentLocus != "PCSK9",]
...
#' ## Plot 
p4 = plotData1 |>
  forestplot(labeltext = c(exposure1, exposureSex, outcomeSource, CI, FStat2),
             boxsize = 0.25,
...
filename = paste0("../results/SupplementalFigures/SupFig8_MVMRIVW_HMGCR_PCSK9.png")

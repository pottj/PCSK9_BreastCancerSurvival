...
pQTLData[ rsID == "rs693668",]
pQTLData = pQTLData[rsID == "rs693668",]
pQTLData
...
IVData[pval<1e-6,]
IVData[pval<0.05,]
save(IVData,file = "../results/07_SumStats_rs693668.RData")
...
#' Save data 
save(IVData, outcomeData,file = "../results/07_SumStats_rs693668.RData")
...
#' # Save data ####
#' ***
save(MR_ratio, file = "../results/07_MR_ratio_rs693668.RData")
...
plotData$phenotype
plotData$Exposure = c("PE (women, statin-treated)",
                      "PE (women)",
...
p2<- forest(plotData[,c(29,27,28)],
            ...
            title = "MR of PCSK9 levels on breast cancer survival (rs693668)")

plot(p2)

filename = paste0("../results/07_ForestPlots_rs693668_BCS.png")
...
p2<- forest(plotData[,c(29,27,28)],
            ...
            ref_line = 0,
            xlab = "Causal effect estimate",
            title = "MR of PCSK9 levels on breast cancer (rs693668)")

plot(p2)

filename = paste0("../results/07_ForestPlots_rs693668_BC.png")
png(filename = filename,width = 1800, height = 900, res=200)
plot(p2)
dev.off()

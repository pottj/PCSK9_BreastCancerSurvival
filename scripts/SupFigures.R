...
plotData1[outcome == "PLD - UKB", outcome := "PLD [UKB]"]
...
plotData2[outcome == "PLD - UKB", outcome := "PLD [UKB]"]
...
plotData3[outcome == "PLD - UKB", outcome := "PLD [UKB]"]
...
plotData4a[outcome == "PLD - UKB", outcome := "PLD [UKB]"]

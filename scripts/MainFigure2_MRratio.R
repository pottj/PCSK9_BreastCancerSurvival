...
p2a = plotData2 |>
  ...
  forestplot(labeltext = c(outcomeSource, outcomeModel, maxSamples, CI),
             ...
             xlab = "logHR (95% CI) for BC Survival per 1-SD increment in PCSK9 levels",
             clip = c(-10,100),
             align = c("l","l","r","r"),
             #xlog = TRUE,
             vertices = TRUE,
...
filename = paste0("../results/MainFigures/Fig2A_MRratio.png")
...
filename = paste0("../results/MainFigures/Fig2B_MRratio.png")
